<?php
    ...
    $sql = " SELECT user_email FROM users WHERE user_id = '$id_usr_session' AND check_profile_complete = 1 ";
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="right-section">
                            ...
                            <h1 id="stepTitle text-danger fs-4">Your profile is not completed. Please complete your profile first from <a href="edit_profile.php">here</a></h1>
