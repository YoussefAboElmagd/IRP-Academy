                ...
                <div class="row bg-body-secondary p-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="right-section bg-white ">
                          ...
                          <div class="bg-white p-4">
                                <h1 class="font-bold text-2xl italic mb-8 fs-2">Aim & Scope</h1>
                                <p class="mb-4 fs-6">JBSR stands as an international, cross-disciplinary, scholarly, open-access journal focused on the technical, environmental, cultural, economic, social, and business sustainability research of humanity. It serves as an advanced platform for studies pertaining to business and sustainable development. Published four times a year and subjected to peer review, JBSR accommodates reviews, regular research papers, communications, and short notes, without imposing restrictions on paper length.</p>
                                <p class="mb-4 fs-6">Our primary objective is to motivate researchers to share their experimental, computational, and theoretical research across natural and applied sciences, engineering, economics, social sciences, and humanities. By providing comprehensive insights, our aim is to advance scientific understanding, facilitate predictions, and conduct impact assessments related to global change and development within the business sustainability context. Recognizing the critical significance of business sustainability and the pursuit of sustainable development for humanity, Sustainability aligns itself with the 2030 Agenda for Sustainable Development endorsed by the United Nations. Functioning as a transdisciplinary journal, we encourage researchers to present thorough experimental and methodological details, fostering result reproducibility and assessment. JBSR staunchly supports the principles of open access and open science.</p>
