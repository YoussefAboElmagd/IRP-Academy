                ...
                <div class="row bg-body-secondary p-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="right-section bg-white ">
                          ...
                          <div class="bg-white p-4">
                                <h1 class="font-bold text-2xl italic mb-8 fs-2">Instructions for Authors</h1>
                                <p class="mb-4 fs-6">All manuscript submitted to this journal have to be original. That means it should not have been published before in its current, or similar, form or under-review elsewhere and should not be under consideration by any other publication. The only exceptions to this rule are outlined in our pre-print and conference paper policies.  If any substantial element of your paper has been previously published, you need to declare this to the journal editor upon submission. Please note, the journal editor may use Crossref Similarity Check to check on the originality of submissions received. This service compares submissions against a database of works from scholarly publishers. Please If you have a conflict of interest, you must declare it upon submission; this allows the editor to decide how they would like to proceed. It is the responsibility of the authors to state if you have any copyright permission from third party.  Ethics approval for any research related to animal and human has to be submitted with manuscripts. Please note that <strong>Plagiarism, data fabrication and image manipulation are not tolerated</strong>. We use appropriate software for checking the similarity and any manuscript that do not follow appropriate academic standards is rejected.</p>
